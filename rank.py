...
def main():
    ...
    previous_season_team_pages_directory: str = os.path.join("team_pages/2023/2023-week13-results")
    ...
    compare_rankings(read_ranking("rankings/2024/2024-week14.txt"), rank1)
